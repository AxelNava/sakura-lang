...
pub const W_SELFLOWER: &str = "self";
pub const W_SELFUPPER: &str = "Self";
...
pub const W_INTER8: &str = "i8";
pub const W_INTER16: &str = "i16";
pub const W_INTER32: &str = "i32";
pub const W_INTER64: &str = "i64";
pub const W_FLOAT32: &str = "f32";
pub const W_FLOAT64: &str = "f64";
